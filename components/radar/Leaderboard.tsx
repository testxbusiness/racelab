...
export function Leaderboard({ timing, favouriteDriverNumber, onDriverSelect }: { timing: LiveDriverTiming[]; favouriteDriverNumber: number | null; onDriverSelect: (driver: LiveDriverTiming) => void }) {
