...
export function TrackMapPanel({ sessionKey, timing, favouriteDriverNumber }: { sessionKey: number; timing: LiveDriverTiming[]; favouriteDriverNumber: number | null }) {
  const map = useTrackMapData(sessionKey);
